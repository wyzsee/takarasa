                ...
                <div className="container w-full flex flex-col items-center mx-auto gap-4 py-4 h-full">
                    <div className="flex flex-wrap relative justify-between w-full items-center gap-3">
                        <div className="rounded-xl w-full">
                                ...
                                <div className="flex flex-col gap-2 justify-between items-center w-full">
                                    ...
                                    >
                                        ...
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M2.79102 7.89816L3.32279 7.82099L4.68477w-484897L4.15299 7.52615L2.79102 7.89816Z"
                                            fill="#6580E1"
                                            fill-opacity="0.741176"
                                        />
                                        <path
                            ...
                            {alphabet.map((letter) => (
                                <div key={letter} className="flex flex-col justify-center items-center w-full mt-4 gap-4">
                                    <div className="w-full flex justify-between items-center">
                                        <h1 className="text-base font-medium text-grey-100">
                                            Huruf {letter}
                                        </h1>
                                        <Link to="/belajar-bahasa-isyarat">
                                            <CaretRight size={24} />
                                        </Link>
                                    </div>
